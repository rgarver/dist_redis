...
//     })
//
global.describe = exports.describe = function(desc) {
...
global.test = exports.test = function(desc, callback) {
...
//     })
//
global.before = exports.before = function(callback) {
  if(!exports.testSuite.currentTestCase)
    this.describe();
...
global.after = exports.after = function(callback) {
  if(!exports.testSuite.currentTestCase)
    this.describe();
  return exports.testSuite.currentTestCase.after(callback);
}

global.it = exports.it       = exports.test;
global.setup = exports.setup    = exports.before;
global.teardown = exports.teardown = exports.after;
...
global.testSuite = exports.testSuite = {
  runOnExit: true,
  runOnCreation: true,
  passed: 0,
  failed: [],
